...
const DetailsStep = ({ setTransactionStep, setTargetWalletAddress, setAssetAmountToSend,  }) => {
    const onCloseClick = () => {
    ...
    return (
        <div className="details text-center">
            ...
            <p className="font-normal py-8">Tx Hash: <a className="txHash" href="/">0x410x4338937459827345</a></p>
